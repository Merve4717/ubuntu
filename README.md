...
*1.0 Öncelikle ubuntu desktop'ı kurmak için bu ISO dosyasını yüklememiz gerek.*
...
*1.2 Dosyalarımız indikten sonra flash bellek'imizi bilgisayarımıza takıp seç kısmından indirdiğimiz ubuntu dosyamızı ve diskimizi seçiyoruz.*
...
*3.0 Yükleyici başlatıldığında dilinizi seçmeniz istenecektir*
